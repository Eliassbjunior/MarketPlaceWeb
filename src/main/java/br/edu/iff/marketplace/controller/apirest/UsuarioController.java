...
@RestController
@RequestMapping(path = "/apirest/marketplace/usuarios")
public class UsuarioController {
    ...
    @GetMapping(path = "/busca?={usuario}")
    public ResponseEntity getUsuario(@RequestParam("usuario") String usuario){
        return ResponseEntity.ok(service.findByNome(usuario));
    }
    ...
    service.updateSenha(u, senhaAtual, novaSenha, confirmarNovaSenha);
